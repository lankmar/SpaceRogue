...
namespace Scriptables.Health
{
    ...
    {
        [field: SerializeField, Min(0f)] public float MaximumHealth { get; private set; } = 1.0f;
        [field: SerializeField, Min(0f)] public float StartingHealth { get; private set; } = 1.0f;
